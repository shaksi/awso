    ...
    <div
        ...
        <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            <a class="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                <img src="{{ mix('/img/logo.png') }}" style="
    max-width: 40%;
"/>
            </a>
        ...
        <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            ...
            <div class="w-full px-4 lg:w-1/4 md:w-1/2" id="contact">
                ...
                <nav class="mb-10 list-none">
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900" href="mailto:awso@gmail.com">awso@gmail.com</a>
                    </li>
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900" href="tel://+252616303053">+252 61 6303053</a>
                    </li>
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900" href="tel://+252618303053">+252 61 8303053</a>
                    </li>
