                ...
                <div class="px-10 mt-20 sm:flex-1 sm:mt-0 sm:px-0 sm:mt-48 lg:mt-0">
                    <div class="grid grid-cols-2 gap-5">
                        <div class="col-span-1">
                            <img class="min-w-full rounded-md" width="245" height="330" src="{{ mix('/img/class2.jpeg')  }}" />
                            <img class="min-w-full mt-5 rounded-md" width="245" height="245" src="{{ mix('/img/ururka.jpeg')  }}" />
                        </div>
                        <div class="col-span-1 pt-10">
                            <img class="min-w-full rounded-md" width="240" height="240" src="{{ mix('/img/classroom.jpeg')  }}" />
                            <img class="min-w-full mt-5 rounded-md" width="245" height="335" src="{{ mix('/img/bloodp.jpeg')  }}" />
                        </div>
                    </div>
                </div>
            </div>
