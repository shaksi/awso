    ...
    <div class="items-center -mx-6 md:flex md:-mx-12">
      ...
      <div class="w-full px-6 md:w-1/2 md:px-12" id="approach">
        ...
        <div class="flex mt-10">
          <div>
            <svg class="w-10 h-10 text-green-500 stroke-current" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z">
              </path>
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.879 16.121A3 3 0 1012.015 11L11 14H9c0 .768.293 1.536.879 2.121z"></path>
            </svg>
          </div>
          <div class="mt-2 ml-4" id="mission">
            <div class="text-lg font-semibold">Mission</div>
            <p class="mt-2 text-gray-700">
              AWSO works to end violence and abuse against women the full realization of their rights in Somalia through prevention, intervention and advocacy.
            </p>
          </div>
        </div>
        <div class="flex mt-10">
          ...
          <div class="mt-2 ml-4">
            <div class="text-lg font-semibold">Vision</div>
            <p class="mt-2 text-gray-700">
              AWSO envisions a safer, fairer, happier and healthier nation for women.
            </p>
          </div>
        </div>
        <div class="flex mt-10">
          ...
          <div class="mt-2 ml-4">
            <div class="text-lg font-semibold">Focus Area</div>
            <p class="mt-2 text-gray-700">
              <u class="no-underline mt-2 text-gray-700">
                <li>Human Rights </li>
                <li>Protection and Shelter </li>
                <li>Health and Nutrition </li>
                <li>Education and livelihood </li>
                <li>Water & Sanitation </li>
                <li>Food Security and Agriculture 
                </li>
              </u>
            </p>
          </div>
